...
public class MOCAScoresHelper extends SQLiteOpenHelper {
    public MOCAScoresHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
