...
public class FAQScoresAdapter {
    //db version
    private static final int DATABASE_VERSION = 1;
    //db name
    private static final String DATABASE_NAME = "FAQScores.db";
    //variable to hold db instance
    private static SQLiteDatabase db;
    //db ug helper
    private FAQScoresHelper scoresHelper;


    //constructor
    public FAQScoresAdapter(Context context) {
        scoresHelper = new FAQScoresHelper(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    //opens database
    public FAQScoresAdapter open() throws SQLException {
