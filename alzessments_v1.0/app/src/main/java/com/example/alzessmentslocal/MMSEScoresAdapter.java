...
public class MMSEScoresAdapter {
    //db version
    private static final int DATABASE_VERSION = 1;
    //db name
    private static final String DATABASE_NAME = "MMSEScores.db";
    ...
    //constructor
    public MMSEScoresAdapter(Context context) {
        scoresHelper = new MOCAScoresHelper(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    //opens database
    public MMSEScoresAdapter open() throws SQLException {
