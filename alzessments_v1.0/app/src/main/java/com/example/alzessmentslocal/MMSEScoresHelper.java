...
public class MMSEScoresHelper extends SQLiteOpenHelper {
    public MMSEScoresHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
